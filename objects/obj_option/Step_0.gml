...
if (optionselected == 0)
{
    ...
    if ((obj_player.key_jump || keyboard_check_pressed(vk_enter)) && optionsaved_fullscreen == 0)
    {
...
if (optionselected == 1)
{
    ...
    if ((obj_player.key_jump || keyboard_check_pressed(vk_enter)) && optionsaved_resolution == 0)
    {
        ini_open("saveData.ini");
    ...
    if ((obj_player.key_jump || keyboard_check_pressed(vk_enter)) && optionsaved_resolution == 1)
    {
    ...
    if ((obj_player.key_jump || keyboard_check_pressed(vk_enter)) && optionsaved_resolution == 2)
    {
