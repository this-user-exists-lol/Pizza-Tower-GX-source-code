...
{
	var l_q, l_st, l_z, l__g, l__g9, l_b, l_a, l_d, l_v1, l_v2, l__g14, l__hx_tmp, l__g16, l__hx_tmp1, l_b1, l_a1, l_d1, l_o, l_f1, l_f2, l_args1, l_name, l_n, l_i, l_evalArgs, l_val, l_th, l_th0, l_next;
	...
	switch (l__g[0])
	{
	    ...
	    case 22:
	        ...
	        if (l_z && ds_map_find_value(global.g_gml_func_eval, l_name))
	        {
	            ...
	            if (l_i >= l_n)
	            {
	                l_th = global.g_gml_seek_eval_eval_thread;
	                ...
	                l_th0 = global.g_gml_thread_current;
	                ...
	                if (l_th[2] != 4)
	                {
	                    l_next = gml_seek_eval_value_to_node(l_val, l_q[1]);
