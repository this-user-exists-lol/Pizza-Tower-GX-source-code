...
{
	var l__g, l__g1, l_e, l_next, l__g2, l__g11, l_c, l_st, l__seekFunc, l_v;
	
	l__g = 0;
	l__g1 = global.g_gml_program_seek_inst[4];
	...
	while (l__g < array_length_1d(l__g1))
	{
	    ...
	    while (l__g2 < array_length_1d(l__g11))
	    {
	        ...
	        {
	            l_st = ds_list_create();
	            l__seekFunc = global.g_gml_program_seek_func;
	            ...
	            l_v = gml_seek_eval_node_to_value(l_c[3]);
