...
{
	var this, l_flags, l_tk0, l_proc, l_sep, l_nodes, l_s2, l_i, l_d, l_tk, l__g2, l__g5, l_f1, l_d10, l__g6, l_keys, l__g9, l_tmp, l__g22, l_s, l__g311, l_d24, l_node, l__g314, l_node2, l_d20, l_p1;
	...
	l_tk0 = gml_std_haxe_boot_wget(this[1], array_set_post(this, 3, array_get(this, 3) + 1));
	...
	switch (l_tk0[0])
	{
	    ...
	    case 10:
	        ...
	        switch (l_s2)
	        {
	            ...
	            default:
	                ...
	                {
	                    l_i = ds_map_find_value(global.g_gml_asset_index, l_s2);
	        ...
	        switch (l_tk0[2])
	        {
	            case 0:
	                ...
	                else if (gml_std_haxe_boot_wget(gml_std_haxe_boot_wget(this[1], this[3]), 0) == 5)
	                {
	                    ...
	                    {
	                        l__g2 = gml_std_haxe_boot_wget(this[1], this[3]);
	    ...
	    case 24:
	        ...
	        l_nodes = [];
	        l_proc = 1;
	        l__g9 = gml_std_haxe_boot_wget(this[1], this[3]);
	        ...
	        else
	        {
	            while (l_proc && this[3] < this[4])
	            {
	                l__g22 = gml_std_haxe_boot_wget(this[1], this[3]);
	...
	while (l_proc && this[3] < this[4])
	{
	    ...
	    switch (l_tk[0])
	    {
	        ...
	        case 5:
	            ...
	            {
	                array_set(this, 3, array_get(this, 3) + 1);
	                l__g311 = gml_std_haxe_boot_wget(this[1], this[3]);
	        ...
	        case 22:
	            ...
	            if ((l_flags & 2) == 0)
	            {
	                ...
	                l_node = this[11];
	                l__g314 = gml_std_haxe_boot_wget(this[1], this[3]);
