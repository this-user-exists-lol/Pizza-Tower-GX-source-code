...
{
	var this, l_namedArgs, l_namedArgc, l_scr, l_nodes, l__g, l__name;
	
	this = argument[0];
	
	if (argument_count > 2)
	    l_namedArgs = argument[2];
	else
	    l_namedArgs = undefined;
	
	if (argument_count > 3)
	    l_namedArgc = argument[3];
	else
	    l_namedArgc = 0;
	
	l_scr = gml_script_create(this[2], argument[1], (this[3] >= this[4]) ? gml_std_haxe_boot_wget(this[2], 7) : gml_std_haxe_boot_wget(gml_std_haxe_boot_wget(this[1], this[3]), 1));
	...
	while (this[3] < this[4])
	{
	    l__g = gml_std_haxe_boot_wget(this[1], this[3]);
