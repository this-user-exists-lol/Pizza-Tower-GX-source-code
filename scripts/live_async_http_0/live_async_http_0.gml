...
{
	var l_map, l_list, l_n, l_i, l_s, l_scrName, l_scrFunc, l_buf, l_srcMap, l_s1, l_names;
	...
	{
	    l_scrName = ds_list_find_value(l_list, l_i);
	    l_scrFunc = live_script_get_index(l_scrName);
	...
	buffer_delete(l_buf);
	l_srcMap = global.g_live_live_macros;
