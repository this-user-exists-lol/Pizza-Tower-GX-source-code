...
{
	var __bind, __vis, __fore, __back, __x, __y, __htiled, __vtiled, __xscale, __yscale, __stretch, __hspeed, __vspeed, __blend, __alpha, __nearestdepth, __farthestdepth, __depthinc, __result, __fgstring, __bgstring, __colstring, __fglen, __bglen, __layerlist, __layerlistlength, __collayer, __i, __slots, __isforeground, __layername, __slotchr, __slot, __currdepth, __depth, __layerdepth, __layerid, __backel;
