...
{
	var this, l_tk, l_unknown, l__g3, l_d, l_tk2, l_s, l_i, l_d2, l_nodes, l_proc, l__g5, l_s2, l_d5, l_e, l_sep, l__g33, l__g34, l_ec, l_x1, l__g8, l_x2, l__g36, l_x, l_d7, l_cc, l_c, l__g15, l_pre, l__g101, l__g103, l_d13, l__g17, l_d18, l__g24, l__g, l_i1, l_start, l__g25, l__g26, l__g115, l__g117;
	...
	l_tk = gml_std_haxe_boot_wget(this[1], array_set_post(this, 3, array_get(this, 3) + 1));
	l_unknown = 0;
	...
	switch (l_tk[0])
	{
	    case 9:
	        ...
	        switch (l_tk[2])
	        {
	            ...
	            case 3:
	                l__g5 = gml_std_haxe_boot_wget(this[1], this[3]);
	                ...
	                {
	                    l__g33 = gml_std_haxe_boot_wget(this[1], this[3]);
	                    ...
	                    switch (l__g33[0])
	                    {
	                        ...
	                        case 10:
	                            ...
	                            {
	                                array_set(this, 3, array_get(this, 3) + 1);
	                                l__g34 = gml_std_haxe_boot_wget(this[1], this[3]);
	                                ...
	                                l_ec = gml_enum_ctr_create(l__g33[2], l__g33[1], this[11]);
	            ...
	            case 4:
	                ...
	                l__g8 = gml_std_haxe_boot_wget(this[1], this[3]);
	                ...
	                if (this[3] < this[4])
	                {
	                    l__g36 = gml_std_haxe_boot_wget(this[1], this[3]);
	            ...
	            case 7:
	                ...
	                l__g15 = gml_std_haxe_boot_wget(this[1], this[3]);
	                ...
	                while (this[3] < this[4] && l_proc)
	                {
	                    l__g101 = gml_std_haxe_boot_wget(this[1], this[3]);
	                        ...
	                        case 9:
	                            switch (l__g101[2])
	                            {
	                                case 8:
	                                    ...
	                                    while (this[3] < this[4])
	                                    {
	                                        l__g103 = gml_std_haxe_boot_wget(this[1], this[3]);
	            ...
	            case 13:
	                ...
	                l__g17 = gml_std_haxe_boot_wget(this[1], this[3]);
	            ...
	            case 18:
	                ...
	                if (this[3] < this[4])
	                {
	                    l__g24 = gml_std_haxe_boot_wget(this[1], this[3]);
	    ...
	    case 1:
	        l__g = gml_std_haxe_boot_wget(this[1], array_set_post(this, 3, array_get(this, 3) + 1));
	    ...
	    case 24:
	        ...
	        if (this[3] < this[4])
	        {
	            l__g25 = gml_std_haxe_boot_wget(this[1], this[3]);
	        ...
	        while (l_proc && this[3] < this[4])
	        {
	            l__g26 = gml_std_haxe_boot_wget(this[1], this[3]);
	...
	if (l_unknown)
	{
	    ...
	    if (this[3] < this[4])
	    {
	        l__g115 = gml_std_haxe_boot_wget(this[1], this[3]);
	...
	if (this[3] < this[4])
	{
	    l__g117 = gml_std_haxe_boot_wget(this[1], this[3]);
