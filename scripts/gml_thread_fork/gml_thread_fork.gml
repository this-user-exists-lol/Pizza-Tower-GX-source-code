...
{
	var this, l_q, l_q_inst, l_r, l_n;
	
	this = argument[0];
	l_q = this[4];
	l_q_inst = l_q[6];
	l_r = gml_thread_create(this[0], l_q[1], gml_value_list_copy(l_q[3]), gml_value_list_copy(l_q[4]), l_q_inst[l_q_inst[0]], l_q_inst[l_q_inst[0] - 1], l_q[2]);
