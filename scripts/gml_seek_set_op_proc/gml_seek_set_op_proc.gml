...
{
	var l_q, l_st, l__g, l_v, l_x, l_o, l_d, l__g1, l_s, l_s1, l_s2, l_x1, l_i, l_x3, l_xw1, l_xd4, l__g3, l_xi1, l_i21, l_i11, l_xw, l_xd3, l__g2, l_xi, l_i2, l_i1, l_s3, l_f, l_k, l_s4, l_s5, l_k4, l_x6, l_k5, l_x7, l_k6, l_i4, l_x8, l_k2, l_x4, l_k3, l_i3, l_x5;
	...
	if (l__g[0] == 28)
	{
	    ...
	    switch (l__g1[0])
	    {
	        ...
	        case 41:
	            l_s3 = l__g1[2];
	            l_f = ds_map_find_value(global.g_gml_var_flags, l_s3);
	            
	            if ((l_f & 1) == 0)
	            {
	                if ((l_f & 2) != 0)
	                {
	                    l_k = [1, l_d, 0, undefined];
