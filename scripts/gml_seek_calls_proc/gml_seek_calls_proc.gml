...
{
	var l_q, l__g, l_w, l_x, l_d, l__g1, l_o, l_n, l_s, l_s3, l_s2, l_n01, l_n11, l_wn1, l_s1, l_n0, l_n1, l_wn;
	...
	if (l__g[0] == 17)
	{
	    ...
	    switch (l__g1[0])
	    {
	        ...
	        case 12:
	            l_s2 = l__g1[2];
	            l_n01 = ds_map_find_value(global.g_gml_func_arg0, l_s2);
	            
	            if (l_n01 != undefined)
	            {
	                l_n11 = ds_map_find_value(global.g_gml_func_arg1, l_s2);
	                l_wn1 = array_length_1d(l_w);
	        ...
	        case 7:
	            l_s1 = l__g1[2];
	            l_n0 = ds_map_find_value(global.g_gml_func_arg0, l_s1);
	            
	            if (l_n0 != undefined)
	            {
	                l_n1 = ds_map_find_value(global.g_gml_func_arg1, l_s1);
	                l_wn = array_length_1d(l_w);
