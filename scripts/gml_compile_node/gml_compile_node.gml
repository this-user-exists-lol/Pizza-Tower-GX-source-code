...
{
	var l_q, l_r, l_out, l__g, l_f, l_d2, l_d, l_x, l__g1, l_x2, l_w, l_n, l_i, l_keys, l_s, l_s19, l_s22, l_o, l__g7, l_p0, l__g2, l_k, l__g5, l__d6, l_pc, l_pb, l_p1, l_p2, l__g20, l__g16, l__g19, l_tmp1, l__g43, l__g17, l_tmp, l__g42, l_p3, l__g23, l__cc, l_jt, l__cv, l_l, l__g9, l_c, l__g10, l_lp, l_d53, l__g24;
	...
	switch (l__g[0])
	{
	    ...
	    case 24:
	        ...
	        {
	            case 32:
	                l_k = ds_map_find_value(global.g_gml_compile_curr_script[6], l__g2[2]);
	    ...
	    case 22:
	        ...
	        if (ds_map_find_value(global.g_gml_func_script, l_s) == -1)
	            return gml_compile_error("Function `" + l_s + "` is pointing at an invalid script.", l__d6);
	        
	        ds_list_add(l_r, [52, l__d6, ds_map_find_value(global.g_gml_func_script, l_s), l_n, ds_map_find_value(global.g_gml_func_args, l_s), ds_map_find_value(global.g_gml_func_rest, l_s), ds_map_find_value(global.g_gml_inst_data, l_s), l_out]);
	        break;
	    ...
	    case 98:
	        ...
	        {
	            l__g20 = ds_list_find_value(l_r, l_k);
	    ...
	    case 95:
	        ...
	        {
	            l__g16 = ds_list_find_value(l_r, l_k);
	    ...
	    case 97:
	        ...
	        {
	            l__g43 = ds_list_find_value(l_r, l_k);
	    ...
	    case 96:
	        ...
	        for (l_k = l_p0; l_k < l_p1; l_k++)
	        {
	            l__g42 = ds_list_find_value(l_r, l_k);
	    ...
	    case 99:
	        ...
	        for (l_k = l_p1; l_k < l_p2; l_k++)
	        {
	            l__g23 = ds_list_find_value(l_r, l_k);
	    ...
	    case 92:
	        ...
	        for (l_i = 0; l_i < l_n; l_i++)
	        {
	            l__cv = gml_std_haxe_boot_wget(l__cc[l_i], 0);
	        ...
	        for (l_k = l_p0; l_k < l_p2; l_k++)
	        {
	            l__g10 = ds_list_find_value(l_r, l_k);
	    ...
	    case 100:
	        ...
	        for (l_k = l_p0; l_k < l_p1; l_k++)
	        {
	            l__g24 = ds_list_find_value(l_r, l_k);
