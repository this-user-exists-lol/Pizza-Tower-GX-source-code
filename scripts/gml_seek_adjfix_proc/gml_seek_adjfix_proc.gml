...
{
	var l_q, l_st, l__g, l_x1, l_d1, l_pre1, l_inBlock1, l__g41, l_o1, l_x, l_d, l_pre, l_inBlock, l__g4, l_o;
	...
	switch (l__g[0])
	{
	    case 25:
	        ...
	        l_inBlock1 = gml_node_is_in_block(l_x1, ds_list_find_value(l_st, 0));
	    ...
	    case 24:
	        ...
	        l_inBlock = gml_node_is_in_block(l_x, ds_list_find_value(l_st, 0));
